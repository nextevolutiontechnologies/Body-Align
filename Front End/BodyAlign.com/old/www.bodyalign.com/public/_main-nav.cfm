...
<cfif session.lang eq 2>Selecciona Idioma<cfelse>Select Language</cfif>
<span class="caret"></span>
</a>
<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
<li role="presentation"><a role="menuitem" tabindex="-1" href="/public/choose-language/?lang=1&returnURL=<cfoutput>#cgi.HTTP_REFERER#</cfoutput>">
<CFIF session.lang EQ 2>Ingles<CFELSE>English</CFIF></a></li>
<li role="presentation"><a role="menuitem" tabindex="-1" href="/public/choose-language/?lang=2&returnURL=<cfoutput>#cgi.HTTP_REFERER#</cfoutput>">
<CFIF session.lang EQ 2>Espa&##241;ol<CFELSE>Spanish</CFIF></a></li> 
</ul>
</div>
</div>
</div>
...
<a href="##" class="dropdown-toggle bg-hover-color" data-toggle="dropdown"><cfif session.lang eq 2>Selecciona Idioma de la<cfelse>Select Language</cfif><b class="caret"></b></a>
<ul class="dropdown-menu">
<li><a href="##" class="bg-hover-color">English</a></li>
<li><a href="##" class="bg-hover-color">Spanish</a></li>
</ul>
</li>
</ul>
</div> <!-- / Navbar Links -->
