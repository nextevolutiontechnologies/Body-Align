...
<cfstoredproc procedure="dbo.pGetPageContent" debug="yes" datasource="#application.datasource#" cachedwithin="#CreateTimespan(0,0,0,0)#">		
    ...
    <cfprocparam cfsqltype="CF_SQL_INTEGER" variable="intContentID" type="in" value="65">
  <CFELSE>
    <cfprocparam cfsqltype="CF_SQL_INTEGER" variable="intContentID" type="in" value="28">
  </CFIF>
