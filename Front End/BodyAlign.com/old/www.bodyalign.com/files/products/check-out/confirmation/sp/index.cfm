...
<li><strong>Env&Iacute;o</strong>:  #dollarformat(pGetOrderInfo_Result.amtShipping)#</li>
<li><strong>Impuesto</strong>:  #dollarformat(pGetOrderInfo_Result.amtTax)#</li>
<li class="lead"><strong>Total de Orden</strong>:  #dollarformat(pGetOrderInfo_Result.amtOrderTotal)#</li>
</ul>
</td>
</tr>
</tbody>
...
<h3><!---Payment Information--->#pGetPageContent_ResultConfirmation.strContentText3#</h3>
<p>
