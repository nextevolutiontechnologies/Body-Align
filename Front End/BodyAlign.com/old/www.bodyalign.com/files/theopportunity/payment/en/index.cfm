...
<a href="/#url.u#/theopportunity/information/?editshipping=1" class="btn btn-green btn-sm pull-right">&laquo; Edit Shipping</a>
</p>
<hr>
...
<strong>Success!</strong> You successfully Updated your contact information.
</div>
</CFCASE>
<CFCASE value="-1">
...
<input type="text" class="form-control isreq" id="strbillname" name="strbillName" maxlength="200" placeholder="Name on Card:" value="#GetBillingInfo.strNameonCard#">
</div>
<div class="form-group">
...
<input type="text" class="form-control isreq" id="strbillstreet" name="strBillStreet" placeholder="Mailing Address:"  value="#GetBillingInfo.strBillingAddress#">
</div>
<div class="form-group">
<label class="sr-only" for="city2"><span class="red">*</span> City:</label>
<input type="text" class="form-control isreq" id="strbillcity" name="strBillCity" placeholder="City:" value="#GetBillingInfo.strBillingCity#">
</div>
<div class="form-group">
...
<input type="text" class="form-control isreq" id="STRZIPCODE" name="strBillZipCode" placeholder="Zip/Postal Code:" value="#GetBillingInfo.strBillingZip#">
</div>
<div class="form-group">
<label class="sr-only" for="email"><span class="red">*</span> Email Address:</label>
<input type="email" class="form-control isreq" id="stremail" name="strEmail" placeholder="Email Address:" value="#GetBillingInfo.strEmail#">
</div>

</div>

<div class="form-group text-right xs-margRight20">
<button type="submit" id="submit-btn" name="submit-btn" class="btn btn-color"> Complete Enrollment &raquo;</button>
</div>
</form>
</CFOUTPUT>