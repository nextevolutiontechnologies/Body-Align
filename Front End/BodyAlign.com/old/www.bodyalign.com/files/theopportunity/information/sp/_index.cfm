...
<input type="text" class="form-control input-sm isreq" id="sponsorname" name="strSponsorname" value="#pGetMemberInfo_Results.strFullName#" placeholder="NOMBRE:">
</div>
<CFELSE>
<div class="form-group col-sm-4">
<label class="sr-only" for="sponsorname">NOMBRE:</label>
#pGetMemberInfo_Results.strFullName#
</div>
<div class="form-group col-sm-4">
<label class="sr-only" for="sponsorname">No. De Distribuidor:</label>
#pGetMemberInfo_Results.intRepID#
</div>	
</cfif>
</div>
<div class="row">
